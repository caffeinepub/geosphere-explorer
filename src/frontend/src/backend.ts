...
export class Backend implements backendInterface {
    ...
    async getAllMonuments(): Promise<Array<MonumentData>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllMonuments();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getMonumentById(arg0: bigint): Promise<MonumentData> {
        if (this.processError) {
            try {
                const result = await this.actor.getMonumentById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMonumentsNear(arg0: number, arg1: number, arg2: number): Promise<Array<MonumentData>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMonumentsNear(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchMonuments(arg0: string): Promise<Array<MonumentData>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchMonuments(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
